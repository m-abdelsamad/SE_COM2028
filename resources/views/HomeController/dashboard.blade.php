                    ...
                    <div class="prof_details edit-prof-details hide">
                        ...
                        <form action="{{url('/dashboard')}}" method="POST" id="edit_details_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 right_side">
                                    <input type="text" class="form-control mb-2 user_name_edit" name="username" value="{{auth()->user()->name}}" required>
                                    <input type="email" class="form-control mb-2 email_edit" name="username" value="{{auth()->user()->email}}" required>
                                    <input type="text" class="form-control mb-2 uni_name_edit" name="username" value="{{auth()->user()->university_name}}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 right_side">
                                    <input type="number" min="1" max="24" class="form-control mb-2 day_hrs_edit" name="username" value="{{(auth()->user()->hrs_per_day/60)/60}}" required>
                                    <input type="number" min="24" max="168" class="form-control mb-2 week_hrs_edit" name="username" value="{{((auth()->user()->hrs_per_week/60)/60)}}" required>
                                </div>
                            </div>
...
const myChart1 = new Chart(ctx1, {
    ...
    data: {
        //user names
        labels: ["Study Hours Goal", "Remaining Hours"],
        datasets: [{
            label: '# of hours',
            //number of hours
            data: [weekGoal, (weekGoal - weeksHours)],
            backgroundColor: [
                'rgba(255, 159, 64, 0.2)',
                'rgba(255, 99, 132, 0.2)',
                'rgba(255, 206, 86, 0.2)',
...
const myChart2 = new Chart(ctx2, {
    ...
    data: {
        ...
        datasets: [{
            label: '# of hours',
            //number of hours
            data: [dayGoal, (dayGoal - todaysHours)],
            backgroundColor: [
                'rgba(255, 206, 86, 0.2)',
                'rgba(75, 192, 192, 0.2)',
                'rgba(153, 102, 255, 0.2)',
